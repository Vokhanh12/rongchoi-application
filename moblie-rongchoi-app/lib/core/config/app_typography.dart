...
class AppText {
  ...
  static init() {
    ...
    h1d = h1!
        .copyWith(fontWeight: FontWeight.w600, color: AppColors.colorDefault);
    h1a =
        h1!.copyWith(fontWeight: FontWeight.w600, color: AppColors.colorAtive);
    ...
    h2d = h2!
        .copyWith(fontWeight: FontWeight.w600, color: AppColors.colorDefault);
    h2a =
        h2!.copyWith(fontWeight: FontWeight.w600, color: AppColors.colorAtive);
    ...
    h3d = h3!
        .copyWith(fontWeight: FontWeight.w600, color: AppColors.colorDefault);
    h3a =
        h3!.copyWith(fontWeight: FontWeight.w600, color: AppColors.colorAtive);
    ...
    b1d =
        b1!.copyWith(fontWeight: FontWeight.w600, color: AppColors.colorAtive);
    ...
    b2a = baseStyle.copyWith(
        fontWeight: FontWeight.w600, color: AppColors.colorDefault);
    b2d =
        b2!.copyWith(fontWeight: FontWeight.w600, color: AppColors.colorAtive);
    ...
    l1a = baseStyle.copyWith(
        fontWeight: FontWeight.w600, color: AppColors.colorDefault);
    l1d =
        l1!.copyWith(fontWeight: FontWeight.w600, color: AppColors.colorAtive);
    ...
    l2a = baseStyle.copyWith(
        fontWeight: FontWeight.w600, color: AppColors.colorDefault);
    l2d =
        l2!.copyWith(fontWeight: FontWeight.w600, color: AppColors.colorAtive);
  }
}